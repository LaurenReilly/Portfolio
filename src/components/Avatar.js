        ...
        return (
            <div className="rounded avatar m-2" style={{border: "1px solid lime", height: "600px", width:"400px"}}>
                <div className="m-auto">
                    ...
                    <p className="ml-3 p-0"><span className="label mr-3">Occupation:</span>Full Stack Web Developer</p>
                    <p className="ml-3 p-0"><span className="label mr-3">Interests:</span>Underwater Gardener, Cat Mom, Gamer, Nature Lover, Comedian, Musician, Cartoonist, Home Chef </p>
                </div>
